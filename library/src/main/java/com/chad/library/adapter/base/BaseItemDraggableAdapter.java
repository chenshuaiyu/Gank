...
public abstract class BaseItemDraggableAdapter<T, K extends BaseViewHolder> extends BaseQuickAdapter<T, K> {
    ...
    private static final String ERROR_NOT_SAME_ITEMTOUCHHELPER = "Item drag and item_text swipe should pass the same ItemTouchHelper";
     ...
     * If the toggle view id is not set, drag event will be triggered when the item_text is long pressed.
     *
